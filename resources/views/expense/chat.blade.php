                            ...
                            <div class="comment-area">
                                ...
                                <textarea class="form-control rounded-pill" placeholder="Type your message here."
                                    ...
                                    <div class="w-50 p-1 d-flex align-items-center">
                                        <button type="submit" class="btn btn-sm btn-danger py-1 w-100 rounded-pill">
                                            Send
                                        </button>
                                    </div>
                                </div>
...
@section('script')
    <script>
        ...
        async function loadComments() {
            ...
            try {
                const response = await fetch('/expense/chats')
                ...
                if (initialLoad) {
                    commentsHolder.scrollTop = commentsHolder.scrollHeight - commentsHolder.clientHeight;
                    initialLoad = false;
                }
