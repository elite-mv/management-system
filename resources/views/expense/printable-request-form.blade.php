    ...
    <div>
        <div class="container p-3 mx-auto" style="position: relative; min-width: 13in;">
            ...
            <div class="row m-0 p-0 mb-3">
                <button class="btn btn-outline-success rounded-0 btn-sm w-25 mx-auto" type="button"
                        onclick="download_print();">
                                        ...
                                        <div class="col-9">
                                            <div class="row">
                                                ...
                                                <div class="col-2 text-start m-0 p-0 border border-dark px-2"
                                                     style="border-style: none none solid solid !important; overflow: hidden; text-overflow: ellipsis;">
                                                    <small
                                                        style="text-wrap: nowrap;">{{$item->measurement->name}}</small>
                                                </div>
                                                <div class="col-2 text-start m-0 p-0 border border-dark px-2"
                                                     style="border-style: none none solid solid !important; overflow: hidden; text-overflow: ellipsis;">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        class="border m-0 p-0 d-flex align-items-center justify-content-center ms-2 me-3"
                                                        style="height: 20px; width: 20px;">
                                                        <img src="../temp/664ecc86248ca.jpg"
                                                             style="height: 100%; width: auto;" name="thumbnail">
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-6 text-start m-0 p-0 border border-dark px-2"
                                                    ...
                                                    <small class="text-lowercase"
                                                           style="text-wrap: nowrap;">{{$item->status}}</small>
                                                </div>
                                                <div class="col-6 text-start m-0 p-0 border border-dark px-2"
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-4 text-start m-0 p-0 border border-dark"
                                        ...
                                        <small>
                                            @management
                                            <input type="text" class="w-100 rounded-0 border-0 px-2"
                                                   value="{{$request->supplier}}" name="paid_to" disabled="">
                                            @else
                                                <input type="text" class="w-100 rounded-0 border-0 px-2"
                                                       value="[HIDDEN]" name="paid_to" disabled="">
                                                @endmanagement
                                        </small>
                                    </div>
                                    <div class="col-2 text-start m-0 p-0 border border-dark px-2"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4 text-start m-0 p-0 border border-dark"
                                        ...
                                        <small>
                                            @management
                                            <input type="text" class="w-100 rounded-0 border-0 px-2"
                                                   value="{{$request->paid_to}}" name="paid_to" disabled="">
                                            @else
                                                <input type="text" class="w-100 rounded-0 border-0 px-2"
                                                       value="[HIDDEN]" name="paid_to" disabled="">
                                                @endmanagement
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-10 m-0 p-0 border border-dark"
                                            ...
                                            <small><select class="px-2 h-100 w-100 border-0" name="type_1r" disabled="">
                                                    ...
                                                    <option value="Supplies and materials">Supplies and materials
                                                    </option>
                                                    ...
                                                    <option value="Other selling expenses">Other selling expenses
                                                    </option>
                                                    <option value="Office/General Administrative Expenses">
                                                    ...
                                                    <option value="Advertising/Promotional">Advertising/Promotional
                                                    </option>
                                                    <option value="Dues and Subscriptions">Dues and Subscriptions
                                                    </option>
                                                    <option value="Rent or Lease of Buildings">Rent or Lease of
                                                        Buildings
                                                    </option>
                                                    ...
                                                    <option value="Meals and entertainment">Meals and entertainment
                                                    </option>
                                                    <option value="Repair and maintenance">Repair and maintenance
                                                    </option>
                                                    ...
                                                    <option value="Management compensation">Management compensation
                                                    </option>
                                                    <option value="Unapplied Cash Bill Payment Expense">Unapplied Cash
                                                        Bill Payment Expense
                                                    </option>
                                                    <option value="Utilities">Utilities</option>
                                                    <option value="Exchange Gain or Loss">Exchange Gain or Loss</option>
                                                    <option value="Other Expense">Other Expense</option>
                                                    <option value="Penalties and settlements">Penalties and
                                                        settlements
                                                    </option>
                                                </select></small>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-10 m-0 p-0 border border-dark"
                                    ...
                                    <small><select class="px-2 h-100 w-100 border-0" name="type_2r" disabled="">
                                            ...
                                            <option value="Payroll Expenses">Payroll Expenses</option>
                                            <option value="Legal and professional fees">Legal and professional fees
                                            </option>
    ...
    <div class="row m-0 p-0">
        ...
        <div class="col-6">
            ...
            <div class="col-2 border border-dark text-center"
                ...
                <small
                    style="position: absolute; top: -10px; left: 50%; transform: translateX(-50%);"><b>RCA</b></small>
            </div>
        </div>
    </div>
    </div>
        ...
        <div class="container px-4">
            <div class="row border border-dark text-start"
                ...
                <div style="overflow-x:hidden; overflow-y:auto; flex: 1; transform: scaleY(-1);" id="comment_window">
                    <div class="card p-3" style="width: 95%; margin: 20px auto; transform: scaleY(-1);">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex flex-row align-items-center"><span><small
                                        class="font-weight-bold text-danger">[Developer]</small><small
                                        class="font-weight-bold">: Be the first one to leave a comment.</small></span>
                            </div>
                            <small class="text-warning">Verified</small></div>
                    </div>
                </div>
                <div class="p-0">
                        ...
                        <div class="comment-area">
                            <div class="bg-dark"
                                ...
                                <div class="w-50 p-1 d-flex align-items-center">
                                    <button type="submit" class="btn btn-sm btn-danger py-1 w-100 rounded-pill">Send
                                    </button>
                                </div>
                            </div>
                        </div>
