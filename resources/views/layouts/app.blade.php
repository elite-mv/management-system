...
<script src="/js/talktify.js"></script>
...
<section class="loader"></section>
        ...
        <div class="row mx-0">
            <nav class="d-none d-md-block col-2 px-0">
                <header class="bg-dark text-light collapse show" id="collapseLayouts">
                    <div class="w-100">
                        <a href="/request">
                            <img class="d-block mx-auto" src="images/logos/ELITE_ACES_LOGO.jpg" height="75px" alt="Management System">
                        </a>
            ...
            <section class="col-12 col-md-10 container-fluid px-0 mx-0" style="background-color: #EDEEF1;">
                <div class="bg-white d-flex align-items-center px-3" style="height: 70px;">
                    <button class="btn btn-link text-dark me-auto collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
  ...
  <!-- Modal -->
  <div class="modal fade" id="imageModalForm" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
