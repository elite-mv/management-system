                    ...
                    <div class="card-body overflow-x-auto">
                        <table class="table sortable">
                            ...
                            @forelse ($companies as $company)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2 align-items-center">
                                            ...
                                            <form data-entity-name="{{$company->name }}" class="delete-form" method="POST" action="/delete-entity/{{$company->id}}">
                                                @csrf
                                ...
                                <div class="modal fade" id="editEntity{{$company->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="{{$company->priority}}" name="priority" class="form-control" id="priority" type="number" min="1" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="name">Name</label>
                                                        <input value="{{$company->name}}" name="name" class="text-uppercase form-control text-uppercase" id="name" type="text" required>
                                                    </div>
                                                    <div class="form-group">
